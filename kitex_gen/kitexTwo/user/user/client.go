...
func (p *kUserClient) CreateUser(ctx context.Context, req *user.CreateUserReq, callOptions ...callopt.Option) (r *user.CreateUserResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateUser(ctx, req)
}

func (p *kUserClient) LoginUser(ctx context.Context, req *user.LoginUserReq, callOptions ...callopt.Option) (r *user.LoginUserResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
